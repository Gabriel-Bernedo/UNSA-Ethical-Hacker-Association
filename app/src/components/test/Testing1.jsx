          ...
          <div className="relative rounded-e-2xl bg-gradient-to-t from-gray-900/50 from-gray-900/25  pt-32 sm:pt-48 lg:pt-40">
            <div className="p-4 sm:p-6">
              ...
              <p className="mt-2 line-clamp-10 text-sm/relaxed text-stone-300 text-justify">
                La ciberseguridad no es solo una disciplina para nosotros; es
                una pasión que impulsa cada uno de nuestros pasos. Nos emociona
                explorar los entresijos de la seguridad digital, comprender las
                amenazas emergentes y desarrollar habilidades que nos permitan
                proteger sistemas y datos vitales en un mundo cada vez más
                interconectado.
              </p>
            </div>
          </div>
        ...
        <article className="relative overflow-visible rounded-lg shadow transition hover:shadow-lg">
          ...
          <div className="relative bg-gradient-to-t from-gray-900/50 from-gray-900/25  pt-32 sm:pt-48 lg:pt-40">
            <div className="p-4 sm:p-6">
              ...
              <p className="mt-2 line-clamp-10 text-sm/relaxed text-stone-300 text-justify">
                En el Grupo Shell, creemos en el poder del aprendizaje continuo.
                Nos esforzamos por adquirir nuevos conocimientos, dominar
                herramientas y técnicas, y compartir nuestras experiencias.
                Nuestro objetivo es no solo mejorar nuestras habilidades
                individuales, sino también fomentar un ambiente de colaboración
                donde todos puedan crecer juntos.
              </p>
            </div>
          </div>
        </article>
