...
export default function LandingPage(){
    return (
        <main id="Nosotros" className="overflow-hidden p-5 bg-black">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center gap-8 lg:mx-16">
                <div className="sm:w-1/1 p-5 col-span-2">
                    <div className="text">
                        ...
                        <h2 className="my-4 font-bold text-3xl  sm:text-5xl ">Sobre <span className="text-indigo-600">Nuestro Grupo UEHA</span>
                        </h2>
                        <p class="opacity-50 text-justify text-2xl">
